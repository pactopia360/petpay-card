...
@section('title', 'Login Repartidor | Petpay')
...
<main class="petpay-wp-login">
    ...
    <section class="petpay-wp-login__center">
        <div class="petpay-wp-login__box">
            <h1 class="petpay-wp-login__title">Ingresa como repartidor</h1>
            ...
            <form method="POST" action="{{ route('repartidor.login.store') }}" class="petpay-wp-login__form">
                @csrf

                <label class="petpay-wp-login__sr-only" for="email_or_phone">Teléfono o correo electrónico</label>
                <input
                    id="email_or_phone"
                ...
                <div class="petpay-wp-login__password-field">
                    <label class="petpay-wp-login__sr-only" for="password">Contraseña</label>
                    <input
                        id="password"
                        class="petpay-wp-login__input"
                        type="password"
                        ...
                        required
                    >
                    <button type="button" class="petpay-wp-login__show-password" data-password-toggle aria-label="Mostrar contraseña">Ver</button>
                </div>
                ...
                <button type="submit" class="petpay-wp-login__submit">Iniciar sesión</button>

                <hr class="petpay-wp-login__divider">

                <a href="{{ route('repartidor.google.redirect') }}" class="petpay-wp-login__google">
                    <svg class="petpay-wp-login__google-icon" viewBox="0 0 48 48" aria-hidden="true">
                ...
                <div class="petpay-wp-login__bottom-links">
                    <a href="{{ route('repartidor.password.request') }}">¿Olvidaste tu contraseña?</a>
                    <span class="petpay-wp-login__dot">•</span>
                    <a href="{{ route('repartidor.register') }}">Registrar repartidor</a>
                </div>
            </form>
        </div>
    </section>
